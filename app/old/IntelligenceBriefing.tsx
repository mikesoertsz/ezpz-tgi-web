...
import { Github, Twitter, Linkedin, Facebook, Instagram, Mail, ChevronDown, ChevronUp, RefreshCw, Copy, Trash2, Edit, CheckCircle, Circle, Coins } from 'lucide-react';
  ...
  const handleSaveField = (field: string, value: string, section?: string, index?: number) => {
    setPersonData(prev => {
      ...
      if (section === 'businesses' && index !== undefined) {
        newData.businesses[index] = { ...newData.businesses[index], [field]: value };
      } else if (section === 'properties' && index !== undefined) {
        newData.properties[index] = { ...newData.properties[index], [field]: value };
      } else if (section === 'financialAssets') {
        newData.financialAssets = { ...newData.financialAssets, [field]: value };
        ...
        (newData as any)[field] = value.split(', ');
      } else {
            ...
            <DocumentPage>
              ...
              <div className="mb-6">
                <div className="flex gap-6 mb-6">
                  <div className="flex-grow">
                    <h2 className="mb-2 text-lg font-medium text-gray-900">{personData.name}</h2>
                      ...
                      <div className="space-y-2 text-sm">
                        <p>
                          ...
                          {editingSections.personal ? (
                            ...
                            <TerminalText text={personData.dob} isAnimating={refreshingSections.personal || false} delay={200} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.personal ? (
                            ...
                            <TerminalText text={personData.nationality} isAnimating={refreshingSections.personal || false} delay={400} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.personal ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('aliases', value)}
                            />
                          ) : (
                            <TerminalText text={personData.aliases.join(", ")} isAnimating={refreshingSections.personal || false} delay={600} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.personal ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('currentLocation', value)}
                            />
                          ) : (
                            <TerminalText text={personData.currentLocation} isAnimating={refreshingSections.personal || false} delay={800} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.personal ? (
                            ...
                            <TerminalText text={personData.education} isAnimating={refreshingSections.personal || false} delay={1000} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.personal ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('languages', value)}
                            />
                          ) : (
                            <TerminalText text={personData.languages.join(", ")} isAnimating={refreshingSections.personal || false} delay={1200} />
                          )}
                        </p>
                      </div>
                    </Accordion>
                        ...
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('netWorth', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.netWorth} isAnimating={refreshingSections.financial || false} delay={200} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('bankAccounts', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.bankAccounts} isAnimating={refreshingSections.financial || false} delay={400} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('investments', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.investments} isAnimating={refreshingSections.financial || false} delay={600} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('cryptoHoldings', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.cryptoHoldings} isAnimating={refreshingSections.financial || false} delay={800} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              value={personData.financialAssets.offshoreAccounts}
                              isEditing={true}
                              onSave={(value) => handleSaveField('offshoreAccounts', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.offshoreAccounts} isAnimating={refreshingSections.financial || false} delay={1000} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.financial ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('annualIncome', value, 'financialAssets')}
                            />
                          ) : (
                            <TerminalText text={personData.financialAssets.annualIncome} isAnimating={refreshingSections.financial || false} delay={1200} />
                          )}
                        </p>
                      </div>
                    </Accordion>
                      ...
                      <div className="space-y-2 text-sm">
                        <p>
                          ...
                          {editingSections.legal ? (
                            ...
                            <TerminalText text={personData.legal.criminalRecord} isAnimating={refreshingSections.legal || false} delay={200} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.legal ? (
                            ...
                            <TerminalText text={personData.legal.activeLawsuits} isAnimating={refreshingSections.legal || false} delay={400} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.legal ? (
                            ...
                            <TerminalText text={personData.legal.regulatoryViolations} isAnimating={refreshingSections.legal || false} delay={600} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.legal ? (
                            ...
                            <TerminalText text={personData.legal.civilCases} isAnimating={refreshingSections.legal || false} delay={800} />
                          )}
                        </p>
                      </div>
                    </Accordion>
                        ...
                        <p>
                          ...
                          {editingSections.online ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('socialMedia', value, 'onlinePresence')}
                            />
                          ) : (
                            <TerminalText text={personData.onlinePresence.socialMedia} isAnimating={refreshingSections.online || false} delay={200} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.online ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('emailAccounts', value, 'onlinePresence')}
                            />
                          ) : (
                            <TerminalText text={personData.onlinePresence.emailAccounts} isAnimating={refreshingSections.online || false} delay={400} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.online ? (
                            <EditableText
                              ...
                              isEditing={true}
                              onSave={(value) => handleSaveField('digitalFootprint', value, 'onlinePresence')}
                            />
                          ) : (
                            <TerminalText text={personData.onlinePresence.digitalFootprint} isAnimating={refreshingSections.online || false} delay={600} />
                          )}
                        </p>
                        <p>
                          ...
                          {editingSections.online ? (
                            <EditableText
                              value={personData.onlinePresence.communicationMethods}
                              isEditing={true}
                              onSave={(value) => handleSaveField('communicationMethods', value, 'onlinePresence')}
                            />
                          ) : (
                            <TerminalText text={personData.onlinePresence.communicationMethods} isAnimating={refreshingSections.online || false} delay={800} />
                          )}
                        </p>
                      </div>
                    </Accordion>
              ...
              <div className="pt-4 mt-6 border-t border-gray-200">
                ...
                <div className="flex items-center justify-between mt-2">
                  <p className="text-xs font-medium text-gray-900">{personData.classification}</p>
